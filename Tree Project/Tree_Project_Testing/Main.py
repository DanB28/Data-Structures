...
the system had to be reset. so for instance, exit out of cammand line and run again and type in new file.
...
#Main('invalid_two.txt')            # runs the program change the input paremeter to desired file name
